      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <p className="max-w-[500px] mb-9 text-white/80">I excel at crafting elegent embedded system experiences and I am proficient in various programming languages and technologies</p>
            {/* button and socials */}
